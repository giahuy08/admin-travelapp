...
const clickAddTour = async () =>{
    console.log({
      ...
      let link = 'https://app-travelbe.herokuapp.com/restauranttable/createRestaurantTable'
  ...
  useEffect(() => {
    callApi(
      `restauranttable/getAllRestaurantTable`,
      "GET"
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers
                    ...
                    .map((row) => {
                      const { _id, name,detail,size,floor,price,status, checkIn, checkOut, deleted } = row;
                        ...
                        >
                         ...
                         <TableCell align="left">{detail}</TableCell>
                          ...
                          <TableCell align="right">
                            <TableMenu id={_id} name={name} detail={detail} size={size} floor={floor} price={price}  checkIn={checkIn} checkOut={checkOut} deleted={deleted}/>
                          </TableCell>
                        </TableRow>
                      );
                    })}
